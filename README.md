...
[![Run on Google Cloud](https://deploy.cloud.run/button.svg)](https://ssh.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https%3A%2F%2Fgithub.com%2Fgielletm%2Fcloud-run-sigla-test.git&cloudshell_workspace=sigla-main)
